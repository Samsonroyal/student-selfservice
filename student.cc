...
void Student::getData()
{
	...
	cout<<"Enter Registration No.     : "; cin>>admno;
	cout<<"Enter Full Name         : "; cin.ignore(); cin.getline(name,20);
	cout<<"Enter Gender (M/F)      : "; cin>>gender;
	cout<<"Enter Year of Study          : "; cin>>std;
...
{
	cout<<"\n\n.......Student Details......\n";
	cout<<"Registration No.     : "<<admno<<endl;
	cout<<"Full Name         : "<<name<<endl;
	cout<<"Gender            : "<<gender<<endl;
	cout<<"Year of Study          : "<<std<<endl;
...
void searchData()
{
	...
	if(n==s.getAdmno())
	{
	cout<<"The Details of Registration No. "<<n<<" shown herewith:\n";
	s.showData();
	flag++;
	}
	}
...
void deleteData()
{
	...
	cout<<"Enter Registration Number you want to move to Trash : ";
	cin>>n;
	...
	if(n==s.getAdmno())
	{
	cout<<"The Following Registration No. "<<n<<" has been moved to Trash:\n";
	s.showData();
...
void modifyData()
{
	...
	cout<<"Enter Registration Number you want to Modify : ";
	cin>>n;
	...
	if(n==s.getAdmno())
	{
	cout<<"The Following Registration No. "<<n<<" will be modified with new data:\n";
	s.showData();
